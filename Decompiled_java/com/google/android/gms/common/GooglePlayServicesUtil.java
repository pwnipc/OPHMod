...
public final class GooglePlayServicesUtil {
    ...
    public static Dialog a(int i, Activity activity, int i2, DialogInterface.OnCancelListener onCancelListener, int i3) {
        ...
        I i4 = new I(activity, a(activity, i, i3), i2);
        String b = b(activity, i);
        if (b != null) {
            message.setPositiveButton(b, i4);
        }
        switch (i) {
            case 0:
                return null;
            case 1:
                return message.setTitle(x.a).create();
            case ConnectionResult.SERVICE_VERSION_UPDATE_REQUIRED:
                return message.setTitle(x.l).create();
            case 3:
                return message.setTitle(x.Z).create();
            case ConnectionResult.SIGN_IN_REQUIRED:
            case ConnectionResult.RESOLUTION_REQUIRED:
                return message.setTitle(x.f).create();
            case ConnectionResult.INVALID_ACCOUNT:
                Log.e("GooglePlayServicesUtil", "An invalid account was specified when connecting. Please provide a valid account.");
                return message.setTitle(x.c).create();
            case ConnectionResult.NETWORK_ERROR:
                Log.e("GooglePlayServicesUtil", "Network error occurred. Please retry request later.");
                return message.setTitle(x.e).create();
            case ConnectionResult.INTERNAL_ERROR:
                Log.e("GooglePlayServicesUtil", "Internal error occurred. Please see logs for detailed information");
                return message.setTitle(x.f).create();
            case ConnectionResult.SERVICE_INVALID:
                Log.e("GooglePlayServicesUtil", "Google Play services is invalid. Cannot recover.");
                return message.setTitle(x.i).create();
    ...
    public static Intent a(Context context, int i, int i2) {
        switch (i) {
            case 1:
            case ConnectionResult.SERVICE_VERSION_UPDATE_REQUIRED:
                return n(i2) ? o(context) ? Z.Z(GOOGLE_PLAY_SERVICES_PACKAGE) : Z.I("com.google.android.apps.bazaar") : Z.I(GOOGLE_PLAY_SERVICES_PACKAGE);
            case 3:
                return Z.Code(GOOGLE_PLAY_SERVICES_PACKAGE);
            case ConnectionResult.DATE_INVALID:
                return Z.Code();
            default:
                return null;
    ...
    public static boolean a(Resources resources) {
        return (a.Code() && ((resources.getConfiguration().screenLayout & 15) > 3)) || b(resources);
    }
    ...
    public static String b(Context context, int i) {
        ...
        switch (i) {
            case 1:
                return resources.getString(x.J);
            case ConnectionResult.SERVICE_VERSION_UPDATE_REQUIRED:
                return resources.getString(x.j);
            case 3:
                return resources.getString(x.Code);
            default:
    ...
    public static String b(Context context, int i, int i2) {
        ...
        switch (i) {
            case 1:
                String string = a(context.getResources()) ? resources.getString(x.C) : resources.getString(x.B);
                return n(i2) ? string + " (via Bazaar)" : string;
            case ConnectionResult.SERVICE_VERSION_UPDATE_REQUIRED:
                String string2 = resources.getString(x.k);
                return n(i2) ? string2 + " (via Bazaar)" : string2;
            case 3:
                return resources.getString(x.I);
            case ConnectionResult.INVALID_ACCOUNT:
                return resources.getString(x.b);
            case ConnectionResult.NETWORK_ERROR:
                return resources.getString(x.d);
            case ConnectionResult.SERVICE_INVALID:
                return resources.getString(x.h);
            case ConnectionResult.DATE_INVALID:
                return resources.getString(x.g);
            default:
                return resources.getString(x.f);
        }
    }

    private static boolean b(Resources resources) {
        Configuration configuration = resources.getConfiguration();
        return a.I() && (configuration.screenLayout & 15) <= 3 && configuration.smallestScreenWidthDp >= 600;
    }

    public static Dialog getErrorDialog(int i, Activity activity, int i2) {
        return a(i, activity, i2, (DialogInterface.OnCancelListener) null, -1);
    }
    ...
    public static int isGooglePlayServicesAvailable(Context context) {
        ...
        try {
            context.getResources().getString(x.f);
        } catch (Throwable th) {
